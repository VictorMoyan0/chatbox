...
function Home(){
    const features = [
        { id: 'threats', icon: AlertTriangle, title: 'Amenazas y Ataques', description: 'Conoce los principales tipos de ataques informáticos, malware y técnicas de intrusión que amenazan los sistemas modernos.', color: '#ff4d6d' },
